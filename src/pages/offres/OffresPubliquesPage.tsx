...
export function OffresPubliquesPage() {
    ...
    function allerVersDetail(offreId: number) {
        navigate(`/offres/${offreId}`);
    }

    function handleClicPostuler(e: React.MouseEvent, offreId: number) {
        e.stopPropagation();
        navigate(`/offres/${offreId}?postuler=1`);
    }
                        ...
                        {offres.map((offre) => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => allerVersDetail(offre.id)}
                                    onKeyDown={(e) => e.key === "Enter" && allerVersDetail(offre.id)}
                                >
                                    ...
                                    <div className="offre-tile__actions">
                                        <button
                                            ...
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                allerVersDetail(offre.id);
                                            }}
                                        >
                                            Voir détail
                                        </button>
                                        {estCandidat && offre.statut === "PUBLIEE" && (
                                            <button className="btn-gold offre-tile__postuler" onClick={(e) => handleClicPostuler(e, offre.id)}>
                                                Postuler
                                            </button>
                                        )}
                                    </div>
