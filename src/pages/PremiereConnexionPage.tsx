...
import { premiereConnexion } from "../api/authService";
import "./authPage.css";
...
export function PremiereConnexionPage() {
    const location = useLocation();
    const navigate = useNavigate();
    const state = (location.state ?? {}) as LocationState;

    const [email, setEmail] = useState(state.email ?? "");
    const [motDePasseTemporaire, setMotDePasseTemporaire] = useState(state.motDePasseTemporaire ?? "");
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        setLoading(true);
        try {
            await premiereConnexion(email, motDePasseTemporaire, nouveauMotDePasse);
        ...
        <div className="auth-page">
            <div className="auth-panel">
                ...
                <div className="auth-panel__content">
                    ...
                    <p className="auth-panel__text">
                        Votre compte a été créé par un administrateur. Pour continuer, définissez votre propre mot de
                        passe personnel.
                    </p>
                </div>
            </div>
            ...
            <div className="auth-panel-form">
                <div className="auth-card">
                    ...
                    <span className="auth-card__eyebrow">Première connexion</span>
                    <h1>Définir votre mot de passe</h1>
                    <p className="auth-card__subtitle">
                        Confirmez votre mot de passe temporaire, puis choisissez votre mot de passe définitif.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        ...
                        <div className="field">
                            <label htmlFor="motDePasseTemporaire">Mot de passe temporaire</label>
