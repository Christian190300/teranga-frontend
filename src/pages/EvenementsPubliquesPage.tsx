...
export function EvenementsPubliquesPage() {
    ...
    const [evenementSelectionne, setEvenementSelectionne] =
        useState<EvenementDTO | null>(null);
    ...
    return (
        <div className="evenements-page">
            ...
            <section className="evenements-hero">
                <p className="evenements-hero__eyebrow">
                    Talent Sénégal
                </p>
                ...
                <p className="evenements-hero__subtitle">
                    Cérémonies de remise de diplômes, opportunités de stage
                    et rendez-vous à ne pas manquer.
                </p>
            </section>
            ...
            ============================================================ */}
            {erreur && (
                <div className="evenements-alert">
                    {erreur}
                </div>
            )}
            ...
            {chargement ? (
                ...
                >
                    {[0, 1, 2].map((i) => (
                        <div
                            className="evenement-card evenement-card--skeleton"
                            key={i}
                        >
                    ...
                    {evenements.map((e) => (
                        ...
                        >
                            <div className="evenement-card__image-wrap">
                                ...
                                {e.type && (
                                    <span className="evenement-card__type">
                                        {LABELS_TYPE_EVENEMENT[e.type]}
                                    </span>
                                )}
                            </div>
                            ...
                            <div className="evenement-card__body">
                                ...
                                <h2 className="evenement-card__titre">
                                    {e.titre}
                                </h2>
                                ...
                                {e.description && (
                                    <p className="evenement-card__desc">
                                        {tronquer(e.description, 110)}
                                    </p>
                                )}
                ...
                >
                    ...
                    >
                        ...
                        {/* =================================================
                            ...
                            IMPORTANT :
                            L'image + le contenu + le footer sont
                            maintenant dans cette zone.

                            Donc l'image défile avec le contenu.
                        ================================================= */}
                        <div className="evenement-modal__scroll">
                            ...
                            <div className="evenement-modal__media">
                                ...
                                <div className="evenement-modal__media-content">
                                    ...
                                    <h2
                                        id="evenement-modal-titre"
                                        className="evenement-modal__titre"
                                    >
                                        {
                                            evenementSelectionne.titre
                                        }
                                    ...
                                    <p className="evenement-modal__date">
                                        {formatDate(
                                            evenementSelectionne.dateEvenement
                                        )}
                            ...
                            <div className="evenement-modal__body">
                                    ...
                                    <div className="evenement-modal__chips">
                                        {evenementSelectionne.lieu && (
                                            <span className="evenement-modal__chip">
                                                <span className="evenement-modal__chip-label">
                                                    Lieu
                                                </span>
                                ...
                                {evenementSelectionne.description && (
                                    <p className="evenement-modal__desc">
                                        {
                                            evenementSelectionne.description
                                        }
                                    </p>
